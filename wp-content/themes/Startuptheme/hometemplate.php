                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-7 animated fadeInLeft">
                        <div class="text-sm-center text-md-start">
                            <h4 class="text-white text-uppercase fw-bold mb-4">Welcome To LifeSuress</h4>
                    ...
                    <div class="col-lg-5 animated fadeInRight">
                        <div class="calrousel-img" style="object-fit: cover;">
                            <img src="<?php bloginfo('template_directory');?>/img/carousel-2.png"
                    ...
                    <div class="row g-4 justify-content-center">
                        <div class="col-12">
                            <div class="rounded bg-light">
                                <img src="<?php bloginfo('template_directory');?>/img/about-1.png"
    ...
    <div class="container py-5">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                <div class="service-item">
                    <div class="service-img">
                        <img src="<?php bloginfo('template_directory');?>/img/blog-1.png"
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                <div class="service-item">
                    <div class="service-img">
                        <img src="<?php bloginfo('template_directory');?>/img/blog-2.png"
                            class="img-fluid rounded-top w-100" alt="">
                        <div class="service-icon p-3">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                <div class="service-item">
                    <div class="service-img">
                        <img src="<?php bloginfo('template_directory');?>/img/blog-3.png"
                            class="img-fluid rounded-top w-100" alt="">
                        <div class="service-icon p-3">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                <div class="service-item">
                    <div class="service-img">
                        <img src="<?php bloginfo('template_directory');?>/img/blog-4.png"
                            class="img-fluid rounded-top w-100" alt="">
                        <div class="service-icon p-3">
    ...
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            ...
            <div class="col-xl-6 wow fadeInRight" data-wow-delay="0.4s">
                <img src="<?php bloginfo('template_directory');?>/img/carousel-2.png" class="img-fluid w-100" alt="">
            </div>
        </div>
    </div>
</div>
            ...
            <div class="col-lg-6 col-xl-4 wow fadeInUp" data-wow-delay="0.2s">
                ...
                <div class="blog-item">
                    ...
                    <div class="blog-img">
                        ...
                        ?>
                        <img src="<?php echo $image ?>" class="img-fluid rounded-top w-100" alt="">
                    ...
                    <div class="blog-content p-4">
                        <div class="blog-comment d-flex justify-content-between mb-3">
                            <div class="small"><span class="fa fa-user text-primary"></span> <?php the_author(); ?>
                            </div>
                            <div class="small"><span class="fa fa-calendar text-primary"></span>
                                <?php echo get_the_date(); ?></div>
                            <div class="small"><span class="fa fa-comment-alt text-primary"></span> 6 Comments</div>
                        </div>
                        <a href="#" class="h4 d-inline-block mb-3"><?php the_title();?></a>
                        <p class="mb-3"><?php  the_excerpt();  ?></p>
                        <a href="<?php the_permalink();?>" class="btn p-0">Read More <i
    ...
    <div class="container pb-5">
        ...
        <div class="row g-4">
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.2s">
                <div class="team-item">
                    <div class="team-img">
                        <img src="<?php bloginfo('template_directory');?>/img/team-1.jpg"
                            class="img-fluid rounded-top w-100" alt="">
                        <div class="team-icon">
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.4s">
                <div class="team-item">
                    <div class="team-img">
                        <img src="<?php bloginfo('template_directory');?>/img/team-2.jpg"
                            class="img-fluid rounded-top w-100" alt="">
                        <div class="team-icon">
                            <a class="btn btn-primary btn-sm-square rounded-pill mb-2" href=""><i
                                    class="fab fa-facebook-f"></i></a>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.6s">
                <div class="team-item">
                    <div class="team-img">
                        <img src="<?php bloginfo('template_directory');?>/img/team-3.jpg"
                            class="img-fluid rounded-top w-100" alt="">
                        <div class="team-icon">
                            <a class="btn btn-primary btn-sm-square rounded-pill mb-2" href=""><i
                                    class="fab fa-facebook-f"></i></a>
            ...
            <div class="col-md-6 col-lg-6 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
                <div class="team-item">
                    <div class="team-img">
                        <img src="<?php bloginfo('template_directory');?>/img/team-4.jpg"
                            class="img-fluid rounded-top w-100" alt="">
                        <div class="team-icon">
                            <a class="btn btn-primary btn-sm-square rounded-pill mb-2" href=""><i
                                    class="fab fa-facebook-f"></i></a>
        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.2s">
            <div class="testimonial-item bg-light rounded">
                <div class="row g-0">
                    <div class="col-4  col-lg-4 col-xl-3">
                        <div class="h-100">
                            <img src="<?php bloginfo('template_directory');?>/img/testimonial-1.jpg"
            ...
            <div class="testimonial-item bg-light rounded">
                <div class="row g-0">
                    <div class="col-4  col-lg-4 col-xl-3">
                        <div class="h-100">
                            <img src="<?php bloginfo('template_directory');?>/img/testimonial-2.jpg"
                                class="img-fluid h-100 rounded" style="object-fit: cover;" alt="">
                        </div>
                    </div>
                    <div class="col-8 col-lg-8 col-xl-9">
            ...
            <div class="testimonial-item bg-light rounded">
                <div class="row g-0">
                    <div class="col-4  col-lg-4 col-xl-3">
                        <div class="h-100">
                            <img src="<?php bloginfo('template_directory');?>/img/testimonial-3.jpg"
                                class="img-fluid h-100 rounded" style="object-fit: cover;" alt="">
                        </div>
                    </div>
                    <div class="col-8 col-lg-8 col-xl-9">
